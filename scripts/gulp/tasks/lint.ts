...
Gulp.task(`lint`, () =>
  Sequence([`lint:data`, `lint:sass`, `lint:typescript`]),
);

Gulp.task(`lint:data`, () => Gulp.src(SRC.DATA).pipe(YamlValidate()));

Gulp.task(`lint:sass`, () => Gulp.src(SRC.SASS).pipe(StyleLint()));
